 ...
 */
public class PopularDetailsMovieTask extends AsyncTask<String, Void, MovieDetail> {

    private final String LOG_TAG = PopularDetailsMovieTask.class.getSimpleName();

    PopMoviesDetailFragment popMoviesDetailFragment;

    public PopularDetailsMovieTask(){
        popMoviesDetailFragment = new PopMoviesDetailFragment();
    }
